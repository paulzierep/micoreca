## Curation of the workflowhub output
In order to have the most relevant tool to the microbiome community we manually curated the workflowhub output generated by the python web scrapping tool. 
To do so we excluded the tools where the description evoled around terms like: 
